...
public interface HSCIEReferralSearch extends Repository {

    List<HSCIEReferralSummary> findAllReferrals(String patientId, List<DataSourceSummary> datasourceSummaries);

    HSCIEReferralDetails findReferral(String patientId, String referralId, String sourceId);
}
