...
public interface HSCIEAppointmentSearch extends Repository {

    List<HSCIEAppointmentSummary> findAllAppointments(String patientId, List<DataSourceSummary> datasourceSummaries);

    HSCIEAppointmentDetails findAppointment(String patientId, String appointmentId, String sourceId);
}
