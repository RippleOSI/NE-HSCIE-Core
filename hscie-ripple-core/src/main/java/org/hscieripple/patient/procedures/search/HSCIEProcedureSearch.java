...
public interface HSCIEProcedureSearch extends Repository {

    List<HSCIEProcedureSummary> findAllProcedures(String patientId, List<DataSourceSummary> datasourceSummaries);

    HSCIEProcedureDetails findProcedure(String patientId, String procedureId, String sourceId);
}
