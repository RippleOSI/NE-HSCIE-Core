...
public class HSCIENotConfiguredAlertSearch implements HSCIEAlertSearch {
    ...
    public List<HSCIEAlertSummary> findAllAlerts(String patientId, List<DataSourceSummary> datasourceSummaries) {
        throw ConfigurationException.unimplementedTransaction(HSCIEAlertSearch.class);
    }

    @Override
    public HSCIEAlertDetails findAlert(String patientId, String alertId, String sourceId) {
        throw ConfigurationException.unimplementedTransaction(HSCIEAlertSearch.class);
    }
}
