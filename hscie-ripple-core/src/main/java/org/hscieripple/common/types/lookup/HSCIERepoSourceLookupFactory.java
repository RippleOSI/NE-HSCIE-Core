 ...
 */
package org.hscieripple.common.types.lookup;
 ...
 */
@Service
public class HSCIERepoSourceLookupFactory implements RepoLookup{

    @Override
    public RepoSourceType getSource(String sourceName) {
        return HSCIERepoSourceTypes.fromString(sourceName);
    }
