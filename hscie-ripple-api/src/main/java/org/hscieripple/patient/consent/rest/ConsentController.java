...
import org.hscieripple.patient.consent.store.ConsentStoreFactory;
...
public class ConsentController {
    ...
    @Autowired
    private ConsentStoreFactory consentStoreFactory;
    ...
    public List<ConsentSummary> findAllConsents(@PathVariable("patientId") String patientId,
        ...
        final ConsentSearch consentSourcesSearch = consentSearchFactory.select(sourceType);
...
;
        final RepoSourceType sourceType = repoSourceLookup.lookup(source);
        final ConsentStore consentStore = consentStoreFactory.select(sourceType);

        consentStore.create(patientId, consent);
    }
    ...
    public void updateConsent(@PathVariable("patientId") String patientId,
        ...
        consentStore.update(patientId, consent);
    }
}
