...
public class HSCIEOrdersController {
    ...
    public List<HSCIEOrderSummary> findAllOrders(@PathVariable("patientId") String patientId,
    ...
    public HSCIEOrderDetails findOrder(@PathVariable("patientId") String patientId,
