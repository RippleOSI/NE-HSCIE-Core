...
public class HSCIEAllergiesController {
    ...
    public List<HSCIEAllergySummary> findAllAllergies(@PathVariable("patientId") String patientId,
    ...
    public HSCIEAllergyDetails findAllergy(@PathVariable("patientId") String patientId,
