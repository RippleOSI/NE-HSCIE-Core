...
public class MedicationsHeadlineResponseToHeadlineTransformer implements Transformer<MedicationsHeadlineResultRow, PatientHeadline> {
    
    @Override
    public PatientHeadline transform(MedicationsHeadlineResultRow response) {
