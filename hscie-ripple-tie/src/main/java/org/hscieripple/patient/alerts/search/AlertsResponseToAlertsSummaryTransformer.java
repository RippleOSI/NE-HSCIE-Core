...
public class AlertsResponseToAlertsSummaryTransformer implements Transformer<AlertsSummaryResultRow, HSCIEAlertSummary> {

	@Override
    public HSCIEAlertSummary transform(final AlertsSummaryResultRow result) {
        final Date dateTime = HSCIEDateFormatter.toDate(result.getDateTime(), result.getDataSourceName());

        final HSCIEAlertSummary details = new HSCIEAlertSummary();
