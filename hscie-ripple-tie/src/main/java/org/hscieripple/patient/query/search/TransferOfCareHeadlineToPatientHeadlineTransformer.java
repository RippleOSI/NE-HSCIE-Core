...
/**
 */
public class TransferOfCareHeadlineToPatientHeadlineTransformer implements Transformer<TransferHeadline, TransferHeadline> {

    @Override
    public TransferHeadline transform(TransferHeadline input) {
    	
    	TransferHeadline headline = new TransferHeadline();
        headline.setSource(input.getSource());
        headline.setSourceId(input.getSourceId());
        headline.setFrom(input.getFrom());
        headline.setTo(input.getTo());
